...
namespace TokenManager.Api
{
    public class Startup
    {
        ...
        {
            services.AddMvc();
            services.AddDbContext<MyTestAuthAppContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DbCon")));
            services.AddLogging();
            ...
            services.AddTransient<MyTestAuthAppContext>();
